...
const Orders = () => {
  ...
  // Define fetchOrders inside useEffect or use useCallback
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      setOrders([]); // In case of an error, ensure orders is an empty array
    }
  }, []);

  useEffect(() => {
    fetchOrders();
  }, [fetchOrders]); // Now fetchOrders is correctly included in the dependency array
