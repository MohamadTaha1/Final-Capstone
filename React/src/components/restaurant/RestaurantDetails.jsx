  ...
  const RestaurantDetails = () => {
    ...
    const handleSubscribeClick = (restaurantId) => {
      localStorage.setItem("selectedRestaurantId", restaurantId);
      // Navigate to the /plans route
      navigate("/plans");
    };
    ...
    return (
      <div className="container min-h-screen mx-auto p-4">
        ...
        <div 
          ...
          onClick={() => handleSubscribeClick(restaurant.id)}
        >
          <button
            className="bg-primary hover:bg-orange-500 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out"
          >
            Subscribe
          </button>
        </div>
